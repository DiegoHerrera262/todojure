...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_61554 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_61554(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_61559 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_61559(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_61562 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_61562(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_61565 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_61565(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_61583 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_61583(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_61590 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_61590(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__61545,callback){
var map__61547 = p__61545;
var map__61547__$1 = cljs.core.__destructure_map(map__61547);
var input = map__61547__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61547__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61547__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
