 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__60419){
var vec__60420 = p__60419;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60420,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60420,(1),null);
var ref = vec__60420;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__60427){
var vec__60429 = p__60427;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60429,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60429,(1),null);
var ref = vec__60429;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__60442){
var map__60443 = p__60442;
var map__60443__$1 = cljs.core.__destructure_map(map__60443);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60443__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
var temp__5751__auto__ = (function (){var and__5043__auto__ = cljs.core.coll_QMARK_(entity);
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__60472,entity,state_map,parent_node,idents_seen){
var map__60476 = p__60472;
var map__60476__$1 = cljs.core.__destructure_map(map__60476);
var join_node = map__60476__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60476__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60476__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__60525,entity,state_map,idents_seen){
var map__60528 = p__60525;
var map__60528__$1 = cljs.core.__destructure_map(map__60528);
var join_node = map__60528__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60528__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__60533){
var map__60534 = p__60533;
var map__60534__$1 = cljs.core.__destructure_map(map__60534);
var node = map__60534__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60534__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var temp__5751__auto__ = (function (){var and__5043__auto__ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(lookup_ref);
if(and__5043__auto__){
...
var vec__60542 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60542,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var e = temp__5751__auto__;
var temp__5751__auto____$1 = (function (){var G__60546 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__60546) : union_key__GT_query.call(null,G__60546));
})();
if(cljs.core.truth_(temp__5751__auto____$1)){
var target_ast_node = temp__5751__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__60551,current_entity,state_map,idents_seen){
var map__60553 = p__60551;
var map__60553__$1 = cljs.core.__destructure_map(map__60553);
var top_node = map__60553__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60553__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60553__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__60554 = nil_nodes;
var G__60554__$1 = (((G__60554 == null))?null:cljs.core.first(G__60554));
if((G__60554__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__60554__$1);
}
})());
} else {
return and__5043__auto__;
...
var G__60556 = result_node__$1;
var G__60556__$1 = (((G__60556 == null))?null:cljs.core.persistent_BANG_(G__60556));
if((G__60556__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__60556__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__60567 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__60567 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__60567,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__60571 = props;
var G__60571__$1 = (((G__60571 == null))?null:cljs.core.meta(G__60571));
if((G__60571__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__60571__$1);
}
});
/**
...
var _STAR_root_keys_and_idents_STAR__orig_val__60576 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_;
var _STAR_root_keys_and_idents_STAR__temp_val__60577 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.transient$(cljs.core.PersistentHashSet.createAsIfByAssoc([root_key_or_ident])));
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__temp_val__60577);
...
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__orig_val__60576);
}});
/**
...
var map__60581 = cljs.core.meta(prior_props);
var map__60581__$1 = cljs.core.__destructure_map(map__60581);
var visited = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60581__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","visited","com.fulcrologic.fulcro.algorithms.denormalize/visited",823384252));
var source_state_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60581__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","source-state-map","com.fulcrologic.fulcro.algorithms.denormalize/source-state-map",-1097808870));
