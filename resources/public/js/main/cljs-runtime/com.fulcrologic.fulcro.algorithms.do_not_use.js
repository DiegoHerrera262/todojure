...
var vec__60224 = ((cljs.core.seq_QMARK_(expr))?cljs.core.ffirst(expr):cljs.core.first(expr));
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60224,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60224,(1),null);
...
var expr__$1 = (function (){var G__60246 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__60246);
} else {
return G__60246;
}
})();
...
if(cljs.core.seq_QMARK_(expr)){
var G__60259 = cljs.core.first(expr);
return (com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1(G__60259) : com.fulcrologic.fulcro.algorithms.do_not_use.join_key.call(null,G__60259));
} else {
return expr;
...
var len__5769__auto___60359 = arguments.length;
var i__5770__auto___60360 = (0);
while(true){
if((i__5770__auto___60360 < len__5769__auto___60359)){
args__5775__auto__.push((arguments[i__5770__auto___60360]));

var G__60361 = (i__5770__auto___60360 + (1));
i__5770__auto___60360 = G__60361;
continue;
} else {
}
break;
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.do_not_use.deep_merge.cljs$lang$applyTo = (function (seq60269){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq60269));
}));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["The composed root query is not valid EQL. The app may crash. See `(comp/get-query ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__60340 = query;
var G__60340__$1 = (((G__60340 == null))?null:cljs.core.meta(G__60340));
var G__60340__$2 = (((G__60340__$1 == null))?null:new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(G__60340__$1));
if((G__60340__$2 == null)){
return null;
} else {
return (component_name_fn.cljs$core$IFn$_invoke$arity$1 ? component_name_fn.cljs$core$IFn$_invoke$arity$1(G__60340__$2) : component_name_fn.call(null,G__60340__$2));
}
})()),")`"].join(''),query], null);
}),null)),null,-1739181586,null);
} else {
}
