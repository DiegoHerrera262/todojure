...
var G__62489 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__62489,"id",id);

goog.dom.appendChild(document.body,G__62489);
...
var G__62492 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__62492,"id",id);

goog.dom.appendChild(document.body,G__62492);
...
var temp__5751__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__62496_SHARP_){
return ((clojure.string.starts_with_QMARK_(p1__62496_SHARP_,"__reactInternalInstance$")) || (clojure.string.starts_with_QMARK_(p1__62496_SHARP_,"__reactFiber$")));
...
com.fulcrologic.fulcro.inspect.element_picker.pick_element = (function com$fulcrologic$fulcro$inspect$element_picker$pick_element(p__62509){
var map__62510 = p__62509;
var map__62510__$1 = cljs.core.__destructure_map(map__62510);
var on_pick = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__62510__$1,new cljs.core.Keyword(null,"on-pick","on-pick",-1995648316),cljs.core.identity);
...
var instance = (function (){var G__62512 = target__$1;
if((G__62512 == null)){
return null;
} else {
return com.fulcrologic.fulcro.inspect.element_picker.react_instance(G__62512);
}
})();
...
var G__62584 = goog.dom.getParentElement(target__$1);
target__$1 = G__62584;
continue;
}
} else {
...
var G__62516_62585 = cljs.core.deref(current);
(on_pick.cljs$core$IFn$_invoke$arity$1 ? on_pick.cljs$core$IFn$_invoke$arity$1(G__62516_62585) : on_pick.call(null,G__62516_62585));
...
var state_map = (function (){var G__62521 = com.fulcrologic.fulcro.components.any__GT_app(comp);
var G__62521__$1 = (((G__62521 == null))?null:new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366).cljs$core$IFn$_invoke$arity$1(G__62521));
if((G__62521__$1 == null)){
return null;
} else {
return cljs.core.deref(G__62521__$1);
}
})();
...
}catch (e62525){var _ = e62525;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","static-query","fulcro.inspect.ui.element/static-query",1120589305),(function (){try{var G__62527 = comp;
var G__62527__$1 = (((G__62527 == null))?null:com.fulcrologic.fulcro.components.react_type(G__62527));
if((G__62527__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$1(G__62527__$1);
}
}catch (e62526){var _ = e62526;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","query","fulcro.inspect.ui.element/query",113020567),(function (){try{var G__62529 = comp;
var G__62529__$1 = (((G__62529 == null))?null:com.fulcrologic.fulcro.components.react_type(G__62529));
if((G__62529__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$2(G__62529__$1,state_map);
}
}catch (e62528){var _ = e62528;
return null;
}})()], null);
});
/**
...
var app_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62541__$1,new cljs.core.Keyword("fulcro.inspect.core","app-uuid","fulcro.inspect.core/app-uuid",-1096445491));
