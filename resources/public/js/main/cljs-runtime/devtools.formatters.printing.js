...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq53010){
var G__53011 = cljs.core.first(seq53010);
var seq53010__$1 = cljs.core.next(seq53010);
var G__53012 = cljs.core.first(seq53010__$1);
var seq53010__$2 = cljs.core.next(seq53010__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53011,G__53012,seq53010__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__53028_SHARP_){
return (!((cljs.core.meta(p1__53028_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53033__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e53034){var _e__51794__auto__ = e53034;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e53036){var _e__51794__auto__ = e53036;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__53041 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__53042 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__53042);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53043__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__53041);
}});
...
var temp__5751__auto___53096 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___53096)){
var managed_print_level_53097 = temp__5751__auto___53096;
var _STAR_print_level_STAR__orig_val__53049_53098 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__53050_53099 = managed_print_level_53097;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__53050_53099);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__53044_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__53044_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__53049_53098);
}} else {
job_fn();
}
