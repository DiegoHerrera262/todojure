...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_55687 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_55687(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_55688 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_55688(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_55689 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_55689(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_55692 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_55692(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_55693 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_55693(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_55694 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_55694(reader);
}
});
...
var G__55717 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__55718 = s.append(c);
c = G__55717;
s = G__55718;
continue;
}
