...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57697_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__57697_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57716_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57716_SHARP_)));
}),row));
});
...
var G__57739 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__57740 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__57739,G__57740) : expound.printer.format.call(null,G__57739,G__57740));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57748_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57748_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57749_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57749_SHARP_)).length),"="));
}),header);
...
var iter__5523__auto__ = (function expound$printer$multirow_$_iter__57754(s__57755){
return (new cljs.core.LazySeq(null,(function (){
var s__57755__$1 = s__57755;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__57755__$1);
if(temp__5753__auto__){
var s__57755__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__57755__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__57755__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__57757 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__57756 = (0);
while(true){
if((i__57756 < size__5522__auto__)){
var row_idx = cljs.core._nth(c__5521__auto__,i__57756);
cljs.core.chunk_append(b__57757,(function (){var iter__5523__auto__ = ((function (i__57756,row_idx,c__5521__auto__,size__5522__auto__,b__57757,s__57755__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__57754_$_iter__57759(s__57760){
return (new cljs.core.LazySeq(null,((function (i__57756,row_idx,c__5521__auto__,size__5522__auto__,b__57757,s__57755__$2,temp__5753__auto__,split_row_contents){
return (function (){
...
var c__5521__auto____$1 = cljs.core.chunk_first(s__57760__$2);
var size__5522__auto____$1 = cljs.core.count(c__5521__auto____$1);
var b__57762 = cljs.core.chunk_buffer(size__5522__auto____$1);
if((function (){var i__57761 = (0);
while(true){
if((i__57761 < size__5522__auto____$1)){
var col_idx = cljs.core._nth(c__5521__auto____$1,i__57761);
cljs.core.chunk_append(b__57762,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__58059 = (i__57761 + (1));
i__57761 = G__58059;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57762),expound$printer$multirow_$_iter__57754_$_iter__57759(cljs.core.chunk_rest(s__57760__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57762),null);
}
} else {
var col_idx = cljs.core.first(s__57760__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__57754_$_iter__57759(cljs.core.rest(s__57760__$2)));
}
} else {
return null;
}
...
});})(i__57756,row_idx,c__5521__auto__,size__5522__auto__,b__57757,s__57755__$2,temp__5753__auto__,split_row_contents))
,null,null));
});})(i__57756,row_idx,c__5521__auto__,size__5522__auto__,b__57757,s__57755__$2,temp__5753__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57757),expound$printer$multirow_$_iter__57754(cljs.core.chunk_rest(s__57755__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57757),null);
}
} else {
var row_idx = cljs.core.first(s__57755__$2);
return cljs.core.cons((function (){var iter__5523__auto__ = ((function (row_idx,s__57755__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__57754_$_iter__57769(s__57770){
return (new cljs.core.LazySeq(null,(function (){
var s__57770__$1 = s__57770;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__57770__$1);
if(temp__5753__auto____$1){
var s__57770__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__57770__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__57770__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__57772 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__57771 = (0);
while(true){
if((i__57771 < size__5522__auto__)){
var col_idx = cljs.core._nth(c__5521__auto__,i__57771);
cljs.core.chunk_append(b__57772,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__58084 = (i__57771 + (1));
i__57771 = G__58084;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57772),expound$printer$multirow_$_iter__57754_$_iter__57769(cljs.core.chunk_rest(s__57770__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57772),null);
}
} else {
var col_idx = cljs.core.first(s__57770__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__57754_$_iter__57769(cljs.core.rest(s__57770__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__57755__$2,temp__5753__auto__,split_row_contents))
;
return iter__5523__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__57754(cljs.core.rest(s__57755__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57779_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__57779_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__57806 = via;
var G__57806__$1 = (((G__57806 == null))?null:cljs.core.last(G__57806));
if((G__57806__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__57806__$1);
}
})();
var keys_specs = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57803_SHARP_){
return cljs.spec.alpha.valid_QMARK_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__57803_SHARP_);
...
}),cljs.core.tree_seq(cljs.core.coll_QMARK_,cljs.core.seq,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"clauses","clauses",1454841241),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57804_SHARP_){
return cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__57804_SHARP_);
}),keys_specs)], 0))], 0))))));
}
});
expound.printer.key__GT_spec = (function expound$printer$key__GT_spec(keys,problems){
var seq__57836_58162 = cljs.core.seq(problems);
var chunk__57837_58163 = null;
var count__57838_58164 = (0);
var i__57839_58165 = (0);
while(true){
if((i__57839_58165 < count__57838_58164)){
var p_58166 = chunk__57837_58163.cljs$core$IIndexed$_nth$arity$2(null,i__57839_58165);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_58166) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__58168 = seq__57836_58162;
var G__58169 = chunk__57837_58163;
var G__58170 = count__57838_58164;
var G__58171 = (i__57839_58165 + (1));
seq__57836_58162 = G__58168;
chunk__57837_58163 = G__58169;
count__57838_58164 = G__58170;
i__57839_58165 = G__58171;
continue;
} else {
var temp__5753__auto___58172 = cljs.core.seq(seq__57836_58162);
if(temp__5753__auto___58172){
var seq__57836_58174__$1 = temp__5753__auto___58172;
if(cljs.core.chunked_seq_QMARK_(seq__57836_58174__$1)){
var c__5568__auto___58177 = cljs.core.chunk_first(seq__57836_58174__$1);
var G__58180 = cljs.core.chunk_rest(seq__57836_58174__$1);
var G__58181 = c__5568__auto___58177;
var G__58182 = cljs.core.count(c__5568__auto___58177);
var G__58183 = (0);
seq__57836_58162 = G__58180;
chunk__57837_58163 = G__58181;
count__57838_58164 = G__58182;
i__57839_58165 = G__58183;
continue;
} else {
var p_58185 = cljs.core.first(seq__57836_58174__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_58185) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__58192 = cljs.core.next(seq__57836_58174__$1);
var G__58193 = null;
var G__58194 = (0);
var G__58195 = (0);
seq__57836_58162 = G__58192;
chunk__57837_58163 = G__58193;
count__57838_58164 = G__58194;
i__57839_58165 = G__58195;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__5045__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57834_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__57834_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__57850){
var vec__57851 = p__57850;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57851,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57851,(1),null);
var G__57854 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57854__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__57856 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57856,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57856,(1),null);
var G__57860 = branch;
...
var i__5770__auto___58228 = (0);
while(true){
if((i__5770__auto___58228 < len__5769__auto___58226)){
args__5775__auto__.push((arguments[i__5770__auto___58228]));

var G__58229 = (i__5770__auto___58228 + (1));
i__5770__auto___58228 = G__58229;
continue;
} else {
}
break;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq57866){
var G__57867 = cljs.core.first(seq57866);
var seq57866__$1 = cljs.core.next(seq57866);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57867,seq57866__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57885_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__57885_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__57886_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__57886_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__57898){
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57912_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__57912_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__57942 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
...
var line = first__57944;
var lines = seq__57943__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57932_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57932_SHARP_)].join('');
}),lines)));
}));
...
while(true){
var vec__57980 = in$;
var seq__57981 = cljs.core.seq(vec__57980);
var first__57982 = cljs.core.first(seq__57981);
var seq__57981__$1 = cljs.core.next(seq__57981);
var k = first__57982;
var rst = seq__57981__$1;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__57994 = show_valid_values_QMARK_;
var G__57995 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__57996 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__57994,G__57995,G__57996) : expound.printer.summary_form.call(null,G__57994,G__57995,G__57996));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__58265 = show_valid_values_QMARK_;
var G__58266 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__58267 = rst__$1;
show_valid_values_QMARK_ = G__58265;
form = G__58266;
in$ = G__58267;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__58000 = show_valid_values_QMARK_;
var G__58001 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__58002 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__58000,G__58001,G__58002) : expound.printer.summary_form.call(null,G__58000,G__58001,G__58002));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__58004 = show_valid_values_QMARK_;
var G__58005 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__58006 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__58004,G__58005,G__58006) : expound.printer.summary_form.call(null,G__58004,G__58005,G__58006));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__58012 = show_valid_values_QMARK_;
var G__58013 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__58014 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__58012,G__58013,G__58014) : expound.printer.summary_form.call(null,G__58012,G__58013,G__58014));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__58017 = show_valid_values_QMARK_;
var G__58018 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__58019 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__58017,G__58018,G__58019) : expound.printer.summary_form.call(null,G__58017,G__58018,G__58019));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58024_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__58024_SHARP_)).length);
...
var map__58033 = problem;
var map__58033__$1 = cljs.core.__destructure_map(map__58033);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58033__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58033__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__58034 = opts;
var map__58034__$1 = cljs.core.__destructure_map(map__58034);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58034__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__58040 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__58041 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__58041);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__58040);
}})();
var vec__58035 = cljs.core.re_find(regex,s);
var seq__58036 = cljs.core.seq(vec__58035);
var first__58037 = cljs.core.first(seq__58036);
var seq__58036__$1 = cljs.core.next(seq__58036);
var line = first__58037;
var first__58037__$1 = cljs.core.first(seq__58036__$1);
var seq__58036__$2 = cljs.core.next(seq__58036__$1);
var prefix = first__58037__$1;
var _more = seq__58036__$2;
