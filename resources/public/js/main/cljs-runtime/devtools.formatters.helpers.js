...
var G__52983 = devtools.prefs.pref(v);
v = G__52983;
continue;
} else {
return v;
...
}catch (e52885){var _e__51794__auto__ = e52885;
return false;
}})();
...
}catch (e52891){var _e__51794__auto__ = e52891;
return false;
}})();
...
}catch (e52898){var _e__51794__auto__ = e52898;
return false;
}}
}
});
...
var vec__52940 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52940,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52940,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__52943_SHARP_);
}),template);
});
